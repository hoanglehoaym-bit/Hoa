...
<div class="main-header">
    <h1>📘 TRỢ LÝ SOẠN GIÁO ÁN TỰ ĐỘNG Lớp 2 (NLS)</h1>
    <p>Tác giả: Hoàng Lệ Hoa - Trường PTDTBT Tiểu học Mậu Long - ĐT: 0856243076</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Lệ Hoa - Trường PTDTBT Tiểu học Mậu Long - ĐT: 0856243076</div>", unsafe_allow_html=True)
